...
namespace v12club.Droid
{
  ...
  public class MainActivity : global::Xamarin.Forms.Platform.Android.FormsAppCompatActivity
  {
    protected override void OnCreate(Bundle bundle)
    {
      ...
      if (Android.OS.Build.VERSION.SdkInt >= Android.OS.BuildVersionCodes.M)
        Android.Support.V4.App.ActivityCompat.RequestPermissions(this, new String[] { Manifest.Permission.RequestInstallPackages }, 0);

      if (Android.OS.Build.VERSION.SdkInt >= Android.OS.BuildVersionCodes.M)
        Android.Support.V4.App.ActivityCompat.RequestPermissions(this, new String[] { Manifest.Permission.ManageAppTokens }, 0);
    }
